window.SanPhamController = function (
  ...
  $scope.addItem = function () {
    ...
    if (index !== -1) {
      ...
      sizes[index].quantity =
        parseInt(sizes[index].quantity) + parseInt(newQuantity);
    } else {
              ...
              $http
                ...
                .then(function (productDetail) {
                  ...
                  $http.post("http://localhost:8080/api/productdetailhistory", {
                    ...
                    idToe: $scope.history.toe.id,
                    idSole: $scope.history.sole.id,
                    idShoelace: $scope.history.shoelace.id,
                    idHeelcushion: $scope.history.heelcushion.id,
  ...
  $("#rangeMin").on("input", function (e) {
    ...
    $("#min").html(
      newValue.toLocaleString("vi-VN", { style: "currency", currency: "VND" })
    );
    $("#line").css({
  ...
  $scope.isToe = false;
  $scope.isSole = false;
  $scope.isShoelace = false;
  $scope.isHeelcushion = false;
  ...
  $scope.themMuiGiay = function () {
    $scope.isToe = !$scope.isToe;
  };
  $scope.themDeGiay = function () {
    $scope.isSole = !$scope.isSole;
  };
  $scope.themDayGiay = function () {
    $scope.isShoelace = !$scope.isShoelace;
  };
  $scope.themLotGiay = function () {
    $scope.isHeelcushion = !$scope.isHeelcushion;
  };
  $scope.themThietKe = function () {
  ...
  $scope.openChiTiet = function (id) {
    ...
    $http
      .get("http://localhost:8080/api/bill/getallbyproduct/" + id)
      .then(function (detail) {
  ...
  $scope.openChiTietLichSu = function (id) {
    ...
    $http
      .get("http://localhost:8080/api/productdetailhistory/get/" + id)
      .then(function (detail) {
        $scope.history = detail.data;
        ...
        $scope.size_Color_Quantity = listColorSize.splice(
          0,
          listColorSize.length - 1
        );
        $scope.mangColorSize = [];
        for (let i = 0; i < $scope.size_Color_Quantity.length; i++) {
          $scope.mang = {};
          $scope.mangColorSize_Quantity =
            $scope.size_Color_Quantity[i].split("-");
          var mang = {
  ...
  $scope.khoiPhuc = function (idHistory) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $http
          .get(
            "http://localhost:8080/api/productdetailhistory/get/" + idHistory
          )
          .then(function (detail) {
            // clear material and color size
            $http.delete(
            ...
            $http
              .put("http://localhost:8080/api/product/update/" + id, {
                ...
                idDesign: detail.data.idDesign,
                idHeelcushion: detail.data.idHeelcushion,
                idShoelace: detail.data.idShoelace,
                idSole: detail.data.idSole,
              ...
              .then(function (productDetail) {
                ...
                $http
                  ...
                  .then(function (product) {
                    ...
                    $http
                      .delete(
                        "http://localhost:8080/api/image/1/" + product.data.id
                      )
                      .then(function (resp) {
                        let listImm = detail.data.imageList.split(",");
                        $scope.imageList = listImm.splice(
                          0,
                          listImm.length - 1
                        );
                ...
                // update size and color
                let listColorSize =
                  detail.data.idColor_Size_Quantity.split(",");
                $scope.size_Color_Quantity = listColorSize.splice(
                  0,
                  listColorSize.length - 1
                );
  ...
  $scope.addMuiGiay = function () {
    $http
      .post(urltoe, {
        name: $scope.toename,
        description: $scope.toedescription,
      })
      .then(function (resp) {
        if (resp.status === 200) {
          Swal.fire("Thêm thành công !", "", "success");
  ...
  $scope.addDeGiay = function () {
    $http
      .post(urlsole, {
        name: $scope.solename,
        description: $scope.soledescription,
      })
      .then(function (resp) {
        if (resp.status === 200) {
          Swal.fire("Thêm thành công !", "", "success");
  ...
  $scope.addDayGiay = function () {
    $http
      .post(urlshoelace, {
        name: $scope.shoelacename,
        description: $scope.shoelacedescription,
      })
      .then(function (resp) {
        if (resp.status === 200) {
          Swal.fire("Thêm thành công !", "", "success");
  ...
  $scope.addLotGiay = function () {
    $http
      .post(urlheelcushion, {
        name: $scope.heelcushionname,
        description: $scope.heelcushiondescription,
      })
      .then(function (resp) {
        if (resp.status === 200) {
          Swal.fire("Thêm thành công !", "", "success");
  ...
  //add design
  $scope.addThietKe = function () {
    $http
      .post(urldesign, {
        name: $scope.designname,
        description: $scope.designdescription,
      })
      .then(function (resp) {
        if (resp.status === 200) {
          Swal.fire("Thêm thành công !", "", "success");
        ...
        if (resp.status === 200) {
          ...
          $http
            ...
            .then(function (detail) {
              for (
                let i = 0;
                i < detail.data.productDetail_materials.length;
                i++
              ) {
                document.getElementById(
                  "Material" +
                    detail.data.productDetail_materials[i].material.id
                ).checked = true;
              }
            });
        ...
        if (resp.status === 200) {
          ...
          $http
            ...
            .then(function (detail) {
              for (
                let i = 0;
                i < detail.data.productDetail_size_colors.length;
                i++
              ) {
                document.getElementById(
                  "Color" + detail.data.productDetail_size_colors[i].color.id
